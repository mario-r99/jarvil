(define
	...
	(:init (at-person workingArea occupant) (on thermostatW) (contol-with temperatureW thermostatW) (at workingArea temperatureW thermostatW) (low temperatureB) (contol-with temperatureB thermostatB) (at bookcaseArea temperatureB thermostatB) (low humidity) (on humidifier) (contol-with humidity humidifier) (at workingArea humidity humidifier) (high airpolusion) (contol-with airpolusion airfilter) (at workingArea airpolusion airfilter) (low brightness) (contol-with brightness light) (at workingArea brightness light) (low temperatureW))
