(define
	...
	(:init (at-person workingArea occupant) (contol-with temperature thermostat) (at workingArea temperature thermostat) (contol-with humidity humidifier) (at workingArea humidity humidifier) (contol-with aircondition airfilter) (at workingArea aircondition airfilter) (contol-with brightness light) (at workingArea brightness light) (high temperature) (low humidity) (high brightness))
