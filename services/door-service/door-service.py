...
def publishingloop():
    ...
    door_state_topic = "time-slot-validation/0/value/door/state"
    readout_frequency = 1
    ...
    while True:
        ...
        # Set actuators
        board.digital[door_port].write(not actuator_setpoint["open"])
        
        #Read actuator status
        door_state = not board.digital[door_port].read()
